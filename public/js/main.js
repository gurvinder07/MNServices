...
function documentReadyInit() {
	...
	//price table style1
	jQuery(".price-table.style1").on('mouseover', function(){
		jQuery(".price-table.style1.hovered").removeClass('hover');
	});
	jQuery(".price-table.style1").on('mouseout', function(){
		jQuery(".price-table.style1.hovered").addClass('hover');
	});
